...
@section('title' , __('Product::translation.delivery.edit'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a
            href="{{ route('panel.delivery.index') }}"> @lang('Product::translation.delivery.index') </a></li>
    <li class="breadcrumb-item active"><a> @lang('Product::translation.delivery.edit')</a></li>
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card overflow-hidden border border-5">
                <div class="card-header border border-5">
                    <div class="alert alert-primary" role="alert">
                        @lang('Product::translation.delivery.edit')
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('panel.delivery.update' , $delivery->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="delivery_unit"
                                           ...
                                           value="{{ old('delivery_unit' ,$delivery->delivery_unit) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        @foreach(\Modules\Product\Models\Delivery::$statuses as $name =>  $status)
                                            <option value="{{ $status }}"
                                                @selected($delivery->status == $status)
                                            > {{ $name }} </option>
                                        @endforeach
                                    </select>
