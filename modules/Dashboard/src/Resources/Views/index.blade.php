            ...
            <div class="card overflow-hidden">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center m-b-10">
                        ...
                        <h2 class="m-b-0 text-primary font-weight-800 primary-font">{{ number_format($totalSalesForCurrentDay) }}</h2>
                    </div>
                    <p> مجموع سفارش امروز </p>
                </div>
            </div>
        </div>
            ...
            <div class="card overflow-hidden">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center m-b-10">
                        ...
                        <h2 class="m-b-0 text-danger font-weight-800 primary-font">{{ number_format($totalSalesInThisMonth) }}</h2>
                    </div>
                    <p>مجموع سفارش ماهانه
                    </p>
                </div>
            </div>
            ...
            <div class="card overflow-hidden">
                <div class="card-body text-center">
                    <div class="d-flex align-items-center justify-content-center m-b-10">
                        ...
                        <h2 class="m-b-0 text-success font-weight-800 primary-font">{{ number_format($totalSalesInThisYear) }}</h2>
                    </div>
                    <p>درآمد کل امسال
                    </p>
                </div>
