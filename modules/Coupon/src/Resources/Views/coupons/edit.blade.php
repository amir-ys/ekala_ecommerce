...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a> @lang('Coupon::translation.edit')</a></li>
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-11">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="start_date"
                                           ...
                                           value="{{old("start_date" , getJalaliDate($coupon->start_date , 'Y-m-d H:i:s' , 'Y/m/d H:i'))}}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="end_date"
                                           ...
                                           value="{{old("end_date" , getJalaliDate($coupon->end_date , 'Y-m-d H:i:s' , 'Y/m/d H:i'))}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="use_type" class="form-control" id="use_type">
                                        ...
                                        @foreach(\Modules\Coupon\Models\Coupon::$useTypes as $name => $value)
                                            <option value="{{ $value }}"
                                                @selected($coupon->use_type == $value)
                                            > {{ $name }} </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control" id="user_select"
                                        {{ \Modules\Coupon\Models\Coupon::USE_TYPE_PRIVATE == $coupon->use_type ? 'disabled' : '' }}>
