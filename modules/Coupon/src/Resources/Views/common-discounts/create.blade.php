...
@section('title' , __('Discount::translation.commonDiscount.create'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a
            href="{{ route('panel.commonDiscounts.index') }}"> @lang('Discount::translation.commonDiscount.index') </a>
    </li>
    <li class="breadcrumb-item active"><a> @lang('Discount::translation.commonDiscount.create')</a></li>
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-11">
            <div class="card overflow-hidden border border-5">
                <div class="card-header border border-5">
                    <div class="alert alert-primary" role="alert">
                        @lang('Discount::translation.commonDiscount.create')
                    </div>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('panel.commonDiscounts.store') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title"
                                           name="title" placeholder="موضوع" value="{{old("title")}}">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        @foreach(\Modules\Coupon\Models\CommonDiscount::$statuses as $name => $value)
                                            <option value="{{ $value }}"
