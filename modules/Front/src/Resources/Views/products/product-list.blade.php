                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="form-group">
                                                    <input type="checkbox" onclick="findProduct('{{ $category->id }}')"
                                ...
                                <div id="order-filters">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <span>
                                                <a href="{{ route('front.products.list') }}?show=list" class="products-view-type {{ request()->show == 'list' || request()->url() == route('front.products.list')   ? 'active' : '' }}"><i class="fa fa-th-list"></i></a>
                                                <a href="{{ route('front.products.list') }}?show=tile" class="products-view-type {{ request()->show == 'tile' ? 'active' : '' }}"><i class="fa fa-th"></i></a>
                                            </span>
                                                &nbsp;|&nbsp;
