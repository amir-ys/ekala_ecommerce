        ...
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 featured-product featured" data-aos="fade-up" data-aos-duration="1000">
                <div class="col">
                    ...
                    <div class="col">
                        ...
                        <div class="product-box">
                            <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p100.png')"></div></a>
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p200.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p300.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p400.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 featured-product on-sale">
                ...
                <div class="col">
                    ...
                    <div class="product-box">
                        <a href="./product.html">
                            <div class="image" style="background-image: url('/assets/front/assets/images/products/p301.png')">
                                <span class="badge on-sale-badge">فروش ویژه</span>
                            </div>
                        </a>
                        <div class="details p-3">
                ...
                <div class="col">
                    ...
                    <div class="product-box">
                        <a href="./product.html">
                            <div class="image" style="background-image: url('/assets/front/assets/images/products/p402.png')">
                                <span class="badge on-sale-badge">فروش ویژه</span>
                            </div>
                        </a>
                        <div class="details p-3">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 featured-product most-visited">
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p403.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p303.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p204.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p302.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
        ...
        <div class="container pt-4">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product mobile" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p101.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p102.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p103.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p104.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product laptop" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p201.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p202.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p203.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product computer" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p301.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p304.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-md-4 most-sales-product camera" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p401.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p402.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
                ...
                <div class="col">
                    <!-- Product Box -->
                    <div class="product-box">
                        <a href="./product.html"><div class="image" style="background-image: url('/assets/front/assets/images/products/p404.png')"></div></a>
                        <div class="details p-3">
                            <div class="category">
                                <a href="./products.html">گوشی موبایل</a>
                                &nbsp;/&nbsp;
