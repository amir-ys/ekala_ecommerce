...
@section('breadcrumb')
    <li class="breadcrumb-item"><a
            href="{{ route('panel.attributes.index') }}"> @lang('Slide::translation.index') </a></li>
                ...
                <div class="card overflow-hidden">
                    <div class="card-header border border-5">
                        <div class="alert alert-primary" role="alert">
                            <div class="row">
                                <div class="col-md-6">
                                    @lang('Slide::translation.edit') "{{ $attribute->name }}"
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8 mt-md-3">
                                                <input type="checkbox" class="form-check" name="is_filterable"
                                                       value="{{ \Modules\Slide\Models\Slide::FILTERABLE_TRUE }}"
                                                    @checked($attribute->is_filterable == \Modules\Slide\Models\Slide::FILTERABLE_TRUE)
                                                >
                                            </div>
                                        </div>
                                    </div>
