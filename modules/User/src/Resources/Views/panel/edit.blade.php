...
@section('title' , __('User::translation.edit'))
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('panel.users.index') }}"> @lang('User::translation.index') </a></li>
    <li class="breadcrumb-item active"><a > @lang('User::translation.edit')</a></li>
@endsection
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card overflow-hidden border border-5">
                <div class="card-header border border-5">
                    <div class="alert alert-primary" role="alert">
                        <div class="row">
                            <div class="col-md-6">
                                @lang('User::translation.edit') "{{ $user->username ?? $user->email }}"
                            </div>
                            <div class="col-md-6">
