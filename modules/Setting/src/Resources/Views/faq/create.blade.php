...
@section('title'  ,__('Setting::translation.faqs.create'))
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a>@lang('Setting::translation.faqs.create')</a></li>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"> @lang('Setting::translation.faqs.create')  </h5>
                    <div class="row justify-content-around">
                        <div class="col-md-6">
                            <div class="card border border-5">
                                <div class="card-header"> فرم @lang('Setting::translation.faqs.create')</div>
                                <div class="card-body">
                                    <form action="{{ route('panel.settings.faqs.store') }}" method="post">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 mt-md-2">
                                                        <input type="checkbox" name="is_published" id="is_published"
                                                               value="{{ \Modules\Setting\Models\Faq::STATUS_PUBLISHED }}" class="form-check">
                                                    </div>
                                                </div>
                                            </div>
